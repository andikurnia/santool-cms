						...
						<?php 
							...
							'items'=>array(
								...
								array('label'=>'Contact', 'url'=>array('/site/contact')),
                                                                array('label'=>'Submenu', 'url'=>'#', 'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>""), 'itemOptions'=>array('class'=>'dropdown'), 'items'=>array(
                                                                    array('label'=>'Sub 1', 'url'=>'#', 'itemOptions'=>array('class'=>'dropdown-submenu')),
                                                                    array('label'=>'Sub 2', 'url'=>'#', 'itemOptions'=>array('class'=>'dropdown-submenu'))
                                                                )),
