...
<div class="container">
                                                        ...
                                                        'bootstrap.widgets.TbNavbar', array(
                                                                      ...
                                                                      'items'=>array(
                                                                                      array('class'=>'bootstrap.widgets.TbMenu',
                                                                                        ...
                                                                                        array('class'=>'bootstrap.widgets.TbMenu',
                                                                                              'items'=>array(array('label'=>'Logout', 'url'=>array('/site/logout/')),),                                                                                                  
                                                                                      ),   
                                                                       )
                                                      ));
                                                ?>
	...
	<div class="row">
		<footer class="span12">
			<div class="row">
				<div class="span8">
					<p>Copyright &copy; <?php echo date('Y'); ?> by Pusat Informasi Humas Universitas Airlangga - All Rights Reserved.</p>
				</div>
				<div class="span4">
					<p style="text-align:right;">Web Design by <a href="https://facebook.com/sani.iman.pribadi" target="_blank">SunSun</a></p>
				</div>
			</div>
		</footer>
	</div><!-- footer -->
