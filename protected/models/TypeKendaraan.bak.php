...
class TypeKendaraan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('kode1, kode2', 'required'),
			array('keterangan_id, perakit_id, pengimport_id, merk_id, status_penggunaan_id, jenis_kendaraan_bawah_id, bahan_utama_rumah_id, jenis_rumah_id', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			...
			'angkutans' => array(self::HAS_MANY, 'Angkutan', 'type_kendaraan_id'),
		);
	}
