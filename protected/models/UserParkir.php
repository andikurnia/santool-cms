 ...
 * @property Angkutan[] $angkutans
 * @property Angkutan[] $angkutans1
 * @property Role $role
 * @property Parkir[] $parkirs
 * @property Parkir[] $parkirs1
 */
class UserParkir extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return UserParkir the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
                        //array('no_paket, no_ktp, name, pekerjaan, telp, alamat, role_id, kota_id', 'required', 'message'=>'{attribute} harus diisi'),
	...
	public function relations()
	{
		...
		return array(
			...
			'angkutans' => array(self::HAS_MANY, 'Angkutan', 'user_id'),
			'angkutans1' => array(self::HAS_MANY, 'Angkutan', 'kuasa_id'),
			'role' => array(self::BELONGS_TO, 'Role', 'role_id'),
			'parkirs' => array(self::HAS_MANY, 'Parkir', 'user_id'),
			'parkirs1' => array(self::HAS_MANY, 'Parkir', 'kuasa_id'),
		);
	}
