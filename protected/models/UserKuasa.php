 ...
 */
class UserKuasa extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return UserKuasa the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('no_ktp, name, pekerjaan, telp, alamat, role_id, kota_id', 'required', 'message'=>'{attribute} harus diisi'),
